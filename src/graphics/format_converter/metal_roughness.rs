...
pub fn convert_texture(data: &Data) -> impl ExactSizeIterator<Item = [u8; 2]> + '_ {
...
fn convert_r8g8b8(pixel: &[u8]) -> [u8; 2] {
    [pixel[2], pixel[1]]
}

fn convert_r16g16b16(pixel: &[u8]) -> [u8; 2] {
    [pixel[4], pixel[2]]
}

fn convert_r8g8(pixel: &[u8]) -> [u8; 2] {
    [0, pixel[1]]
}

fn convert_r16g16(pixel: &[u8]) -> [u8; 2] {
    [0, pixel[2]]
}

fn convert_r8g8b8a8(pixel: &[u8]) -> [u8; 2] {
    [pixel[2], pixel[1]]
}

fn convert_r16g16b16a16(pixel: &[u8]) -> [u8; 2] {
    [pixel[4], pixel[2]]
}

fn convert_r8(_: &[u8]) -> [u8; 2] {
    [0, 0]
}

fn convert_r16(_: &[u8]) -> [u8; 2] {
    [0, 0]
}

fn convert_r32g32b32(pixel: &[u8]) -> [u8; 2] {
    [
...
fn convert_r32g32b32a32(pixel: &[u8]) -> [u8; 2] {
    [
        (255.0 * f32::from_be_bytes([pixel[8], pixel[9], pixel[10], pixel[11]])) as u8,
        (255.0 * f32::from_be_bytes([pixel[4], pixel[5], pixel[6], pixel[7]])) as u8,
    ]
